...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_8_complex_call_helper_star_list(PyObject **python_pars);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_1_complex_call_helper_keywords_star_list_star_dict(PyObject **python_pars);


NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_12_complex_call_helper_keywords_star_list(PyObject **python_pars);


NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_7_complex_call_helper_pos_keywords_star_list_star_dict(PyObject **python_pars);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_3_complex_call_helper_pos_keywords_star_dict(PyObject **python_pars) {
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_3_complex_call_helper_pos_keywords_star_dict);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF(par_kw);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_8_complex_call_helper_star_list(PyObject **python_pars) {
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_8_complex_call_helper_star_list);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF(par_star_arg_list);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_1_complex_call_helper_keywords_star_list_star_dict(PyObject **python_pars) {
...

    {
        ...
        branch_yes_6:;
        {
            ...
            branch_no_7:;
            {
                ...
                tmp_make_exception_arg_4 = BINARY_OPERATION_MOD_UNICODE_TUPLE(tmp_left_name_4, tmp_right_name_4);
                Py_DECREF(tmp_right_name_4);
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_1_complex_call_helper_keywords_star_list_star_dict);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF(par_kw);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_7_complex_call_helper_pos_keywords_star_list_star_dict(PyObject **python_pars) {
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_7_complex_call_helper_pos_keywords_star_list_star_dict);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF(par_kw);
